...
<!-- AUTO-GENERATED by \`npx gitnexus analyze\` (src/cli/ai-context.ts). Do NOT hand-edit between the gitnexus:start/gitnexus:end markers; rerun the CLI instead. Add prose in sections OUTSIDE this block. -->
